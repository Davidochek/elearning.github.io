...
<body>
            ...
            <div class="container" style="background-color: white;">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li><a href="{{ route('login') }}"><i class="fa-sign-in"></i>Login</a></li>
                        ...
                        <li>
                                <button class="btn btn-default" aria-haspopup="true" aria-expanded="true">
                                        <a href="teacher/home"><i class="fa fa-dashboard"></i>Dashboard</a>
                                        </button>
                                    </li>
                               <li>
                                <button class="btn btn-default" aria-haspopup="true" aria-expanded="true">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <li><a href="/student"><button type="button" class="btn-default btn"> Add Class</button></a></li>
  </ul>
  </li>
  ...
  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
    ...
    Teacher <span class="label label-danger">{{$show}}</span>
    <span class="caret"></span>
  </button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <li><a href="#"><button type="button" class="btn-default btn">Profile</button></a></li>
    <li><a href="{{ url('/message') }}"><button type="button" class="btn-default btn"> View Messages</button></a></li>
  </ul>
  </li>
                            <li class="dropdown">
