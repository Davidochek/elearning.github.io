      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <a class="col-md-offset-5 btn btn-success" href="{{ route('posts.create') }}">Add New</a>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td><a href="{{ route('posts.edit', $post->id) }}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    <td>
